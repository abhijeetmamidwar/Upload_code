...
# CREATE TWO FOLDERS NAMED " Fully_solved_codechef_abhijeet_1411 "   AND   " Partially_solved_codechef_abhijeet_1411 "
...
"""  Fully solved """
fully_solved_ids_with_questionCode = {}
                ...
                while True:
                    try:
                        ...
                        if Img.get_attribute('src') == "https://cdn.codechef.com/misc/tick-icon.gif":
                            ...
                            # GET SOLUTION NUMBER AND QUESTION CODE
                            question_code = driver.find_element_by_xpath(
                                f'//*[@id="content"]/div/div/div[1]/h2/a[2]').text
...
"""  Partially solved """
partially_solved_ids_with_questionCode = {}
i = 1  # TRAVERSING ON EVERY CONTEST WHICH HAS PARTIAL SOLUTION SUBMITTED
while True:
